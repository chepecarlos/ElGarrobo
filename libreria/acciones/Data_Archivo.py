from MiLibrerias.FuncionesLogging import ConfigurarLogging
...
def AccionDataArchivo(accion):
    ...
    if Opcion == "asignar":
        logger.info(
            f"Asignar Valor {accion['archivo']}[{accion['atributo']}] a {accion['valor']}")
        SalvarValor(accion['archivo'], accion['atributo'], accion['valor'])
    elif Opcion == "agregar":
        logger.info(
            f"Agregar Valor {accion['archivo']}[{accion['atributo']}] a {accion['valor']}")
        ...
        if Valor < accion['valor']:
            ...
            SalvarValor(accion['archivo'], accion['atributo'], Valor)
            logger.info(
                f"Poner Minimo {accion['archivo']}[{accion['atributo']}] a {Valor}")
    elif Opcion == "maximo":
        Valor = ObtenerValor(accion['archivo'], accion['atributo'])
        ...
        if Valor > Maximo:
            ...
            SalvarValor(accion['archivo'], accion['atributo'], Valor)
            logger.info(
                f"Poner Maximo {accion['archivo']}[{accion['atributo']}] a {Valor}")
    elif Opcion == "pegar":
